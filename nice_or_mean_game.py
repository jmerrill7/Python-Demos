    ...
    if name != "":
        ...
        while stop:
            if name == "":
                ...
                if name != "":
                    print("\nWelcome, {}!".format(name))
                    print("\nIn this game you will choose how to respond to people approaching you. \nYou can be nice or mean.")
                    print("At the end of the game, you will face the consequences of your actions.")
                    stop = False
    return name
...
def nice_mean(nice,mean,name):
    ...
    while stop:
        ...
        if pick == "n":
            ...
            stop = False
        if pick == "m":
            print("\n The stranger cries a little and storms off...")
            mean = (mean + 1)
            stop = False
